...
- **NonDestructiveRead [>2.2]** - When enabled, the controller will use the non-destructive read method [ServerQueuesPeekRead](../API/ServerQueuesPeekRead.md) to transfer data in the changes queue.
